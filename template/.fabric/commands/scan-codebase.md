---
description: Analyze the app's source code to find routes, components, and auth logic
argument-hint: "[path to app source, or leave blank to use APP_REPO_PATH from .env]"
---
...
5. Find all major UI components and save to `code-context/components.json`

6. Find auth logic — how sessions/tokens are checked
7. Save a summary to `code-context/summary.json`:
```json
{
  "framework": "nextjs",
  "totalRoutes": 0,
